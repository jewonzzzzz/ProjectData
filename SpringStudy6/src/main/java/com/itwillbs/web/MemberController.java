...
//		model.addAttribute(resultVO);
	...
	public void test(@RequestBody Map<String, String> salInfo, Model model ) {
		
		logger.debug(salInfo.toString());
	...
	@ResponseBody
	public List<MemberVO> getMemberInfo(@RequestBody Map<String, String> data) {
		
		System.out.println(data);
		
		if(data.get("option").equals("userid")) {
			return mService.getMemberInfoToId(data.get("inputText"));
		}else {
			return mService.getMemberInfoToName(data.get("inputText"));
		}
	}
	
	@PostMapping(value = "/getMemberInfoFormModalToHtml")
	@ResponseBody
	public List<MemberVO> getMemberInfoFormModalToHtml(@RequestBody List<String> data) {
		
		System.out.println(data);
		logger.debug(data.toString());
		
		return mService.getMemberInfoFormModalToHtml(data);
	}
	
	@PostMapping(value ="calSalaryPage")
	public String calSalary(@RequestParam("useridList") List<String> userIds, Model model) {
		
		logger.debug(userIds.toString());
		
		model.addAttribute("useridList", userIds);
		
		return "/member/calSalaryPage";
	}
	
	@GetMapping(value = "selectMemberAll")
	@ResponseBody
	public List<MemberVO> selectMemberAll() {
		return mService.getMemberInfoAll();
	}
