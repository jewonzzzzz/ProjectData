...
//		MemberVO resultVO = sqlSession.selectOne(NAMESPACE+".loginMember", vo);
	...
	public List<MemberVO> getMemberInfoToName(String username) {
		return sqlSession.selectList(NAMESPACE+".getMemberToName", username);
	}
	
	@Override
	public List<MemberVO> getMemberInfoFormModalToHtml(List<String> userList) {
		
		List<MemberVO> resultuserList = new ArrayList<MemberVO>();
		
		for(String userid : userList) {
			MemberVO result = sqlSession.selectOne(NAMESPACE+".getMember", userid);
